...
def load_project_config(config_path='/home/rafi/Desktop/BLLMC/config/config.yaml'):
    ...
    from BLLMC.components.config import ModelConfig, TrainingConfig, DataConfig, RoPEConfig

    raw = read_config(config_path)

    rope_cfg = RoPEConfig(**raw.get("model", {}).pop("rope_freq_config", {}))
    model_cfg = ModelConfig(**raw.get("model", {}), rope=rope_cfg)
